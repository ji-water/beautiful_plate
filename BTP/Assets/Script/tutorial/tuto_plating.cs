...
public class tuto_plating : MonoBehaviour
{
    ...
    public static bool first_noodle;
    ...
    public static void deleteAll() {
        for (int i = 0; i < platedParent.transform.childCount; i++)
        {
            ...
            tutorial_countManage.findRestockIngredient(deletedIngredient);

        }

        tuto_plating.layerOrder = 30f; //재료 순서 초기화

        currentPlatedBase = null;
        tutorial_BaseButManage.baseColliderActive();
    }
    ...
    private void OnMouseDown() {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[0]--;
        //    Debug.Log("빵" + tutorial_countManage.ingredientCount[0]);

        //    if (tutorial_countManage.ingredientCount[0] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedBread();
        //        scriptIngredient.touchedIngredients[0].SetActive(false);
        //    }
          
        //    tutorial_BaseButManage.baseColliderInactive();
        //}
         if (touchedName == "touchedBroth"  && first_noodle == false)
        {
            if (currentPlatedBase == "noodle")
            {
                Clone = Instantiate(platedBroth, platePosition, Quaternion.identity);
                Clone.transform.SetParent(platedParent.transform);
                tutorial_countManage.ingredientCount[1]--;
                Debug.Log("육수" + tutorial_countManage.ingredientCount[1]);

                if (tutorial_countManage.ingredientCount[1] == 0)
                {
                    tutorial_BaseButManage.AllusedBroth();
                    scriptIngredient.touchedIngredients[1].SetActive(false);
                }
                first_noodle = true;
                script_tutoManager.tutoGraphic[11].SetActive(false);
                script_tutoManager.tutoGraphic[12].SetActive(true);
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[2]--;
        //    Debug.Log("케이크" + tutorial_countManage.ingredientCount[2]);

        //    if (tutorial_countManage.ingredientCount[2] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedCake();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[3]--;
        //    Debug.Log("덤플링" + tutorial_countManage.ingredientCount[3]);

        //    if (tutorial_countManage.ingredientCount[3] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedDumpling();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[4]--;
        //    Debug.Log("생선" + tutorial_countManage.ingredientCount[4]);

        //    if (tutorial_countManage.ingredientCount[4] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedFish();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[5]--;
        //    Debug.Log("아이비" + tutorial_countManage.ingredientCount[5]);

        //    if (tutorial_countManage.ingredientCount[5] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedIvy();
        //        scriptIngredient.touchedIngredients[5].SetActive(false);
        //    }
        //    currentPlatedBase = "Ivy";
        //    tutorial_BaseButManage.baseColliderInactive();
        //}
        else if (touchedName == "touchedNoodle" && first_noodle == false)
        {
            Clone = Instantiate(platedNoodle, platePosition, Quaternion.identity);
            Clone.transform.SetParent(platedParent.transform);
            tutorial_countManage.ingredientCount[6]--;
            Debug.Log("국수" + tutorial_countManage.ingredientCount[6]);

            if (tutorial_countManage.ingredientCount[6] == 0)
            {
                tutorial_BaseButManage.AllusedNoodle();
                scriptIngredient.touchedIngredients[6].SetActive(false);
            }

            currentPlatedBase = "noodle";
            tutorial_BaseButManage.baseColliderInactive();
            tutorial_BaseButManage.broth_But.GetComponent<BoxCollider2D>().enabled = true;
        }
        //else if (touchedName == "touchedOmelet")
        //{
        //    Clone = Instantiate(platedOmelet, platePosition, Quaternion.identity);
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[7]--;
        //    Debug.Log("오믈렛" + tutorial_countManage.ingredientCount[7]);

        //    if (tutorial_countManage.ingredientCount[7] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedOmelet();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[8]--;
        //    Debug.Log("파스타" + tutorial_countManage.ingredientCount[8]);

        //    if (tutorial_countManage.ingredientCount[8] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedPasta();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[9]--;
        //    Debug.Log("샐러드" + tutorial_countManage.ingredientCount[9]);

        //    if (tutorial_countManage.ingredientCount[9] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedSalad();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[10]--;
        //    Debug.Log("스테이크" + tutorial_countManage.ingredientCount[10]);

        //    if (tutorial_countManage.ingredientCount[10] == 0)
        //    {
        //        tutorial_BaseButManage.AllusedSteak();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[11]--;
        //    Debug.Log("아스파라거스개수" + tutorial_countManage.ingredientCount[11]);

        //    if (tutorial_countManage.ingredientCount[11] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[12]--;
        //    Debug.Log("바질개수" + tutorial_countManage.ingredientCount[12]);

        //    if (tutorial_countManage.ingredientCount[12] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[13]--;
        //    Debug.Log("브로콜리개수" + tutorial_countManage.ingredientCount[13]);
        //    if (tutorial_countManage.ingredientCount[13] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[15]--;
        //    Debug.Log("방울토마토개수" + tutorial_countManage.ingredientCount[15]);
        //    if (tutorial_countManage.ingredientCount[15] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[18]--;
        //    Debug.Log("무순개수" + tutorial_countManage.ingredientCount[18]);
        //    if (tutorial_countManage.ingredientCount[18] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[11]--;
        //    Debug.Log("구운 아스파라거스 사용->아스파라거스 개수" + tutorial_countManage.ingredientCount[11]);
        ...
        else if (touchedName == "touchedBroccoli_grill")
        {
            ...
            Clone.transform.SetParent(platedParent.transform);
            tutorial_countManage.ingredientCount[13]--;
            Debug.Log("구운브로콜리사용->브로콜리개수" + tutorial_countManage.ingredientCount[13]);
            if (tutorial_countManage.ingredientCount[13] == 0)
            {
                tutorial_VegeButManage.AllusedBroccoli();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[14]--;
        //    Debug.Log("칼+당근->당근개수" + tutorial_countManage.ingredientCount[14]);
        //    if (tutorial_countManage.ingredientCount[14] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[14]--;
        //    Debug.Log("칼+그릴+당근->당근개수" + tutorial_countManage.ingredientCount[14]);
        //    if (tutorial_countManage.ingredientCount[14] == 0)
        //    {
        //        stage1_VegeButManage.AllusedCarrot();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[14]--;
        //    Debug.Log("채칼+당근->당근개수" + tutorial_countManage.ingredientCount[14]);
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[15]--;
        //    Debug.Log("칼+방울토마토->방울토마토개수" + tutorial_countManage.ingredientCount[15]);
        //    if (tutorial_countManage.ingredientCount[15] == 0)
        //    {
        //        stage1_VegeButManage.AllusedCherrytomato();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[16]--;
        //    Debug.Log("칼+오이->오이개수" + tutorial_countManage.ingredientCount[16]);
        //    if (tutorial_countManage.ingredientCount[16] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[16]--;
        //    Debug.Log("채칼+오이->오이개수" + tutorial_countManage.ingredientCount[16]);
        //    if (tutorial_countManage.ingredientCount[16] == 0)
        //    {
        //        stage1_VegeButManage.AllusedCucumber();
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[17]--;
        //    Debug.Log("칼+파프리카->파프리카개수" + tutorial_countManage.ingredientCount[17]);
        //    if (tutorial_countManage.ingredientCount[17] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[21]--;
        //    Debug.Log("블루베리" + tutorial_countManage.ingredientCount[21]);

        //    if (tutorial_countManage.ingredientCount[21] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[21]--;
        //    Debug.Log("체리" + tutorial_countManage.ingredientCount[22]);

        //    if (tutorial_countManage.ingredientCount[22] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[25]--;
        //    Debug.Log("딸기" + tutorial_countManage.ingredientCount[25]);

        //    if (tutorial_countManage.ingredientCount[25] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[19]--;
        //    Debug.Log("사과+칼->사과 개수" + tutorial_countManage.ingredientCount[19]);

        //    if (tutorial_countManage.ingredientCount[19] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[20]--;
        //    Debug.Log("아보카도+칼->아보카도 개수" + tutorial_countManage.ingredientCount[20]);

        //    if (tutorial_countManage.ingredientCount[20] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[23]--;
        //    Debug.Log("레몬+칼->레몬 개수" + tutorial_countManage.ingredientCount[23]);

        //    if (tutorial_countManage.ingredientCount[23] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[24]--;
        //    Debug.Log("오렌지+칼->오렌지 개수" + tutorial_countManage.ingredientCount[24]);

        //    if (tutorial_countManage.ingredientCount[24] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[25]--;
        //    Debug.Log("딸기+칼->딸기 개수" + tutorial_countManage.ingredientCount[25]);
        ...
        else if (touchedName == "touchedBlueberry_juice")
        {
            ...
            tutorial_countManage.ingredientCount[21]--;
            Debug.Log("블루베리+착즙기->블루베리 개수" + tutorial_countManage.ingredientCount[21]);

            if (tutorial_countManage.ingredientCount[21] == 0)
            {
                tutorial_FruitButManage.AllusedBlueberry();
                scriptIngredient.touchedIngredients[21].SetActive(false);
            }

            if (tutorial_toolsButManage.first_juice == true)
            {
                tutorial_toolsButManage.first_juice = false;
                Time.timeScale = 1;
                Invoke("DrawNext", 1.5f);
            }
        ...
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[24]--;
        //    Debug.Log("오렌지+착즙기->오렌지 개수" + tutorial_countManage.ingredientCount[24]);
        ...
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[25]--;
        //    Debug.Log("딸기+착즙기->딸기 개수" + tutorial_countManage.ingredientCount[25]);
        ...
        //        Clone.transform.SetParent(platedParent.transform);
        //    }
        //    tutorial_countManage.ingredientCount[26]--;
        //    Debug.Log("체다치즈" + tutorial_countManage.ingredientCount[26]);

        //    if (tutorial_countManage.ingredientCount[26] == 0)
        //    {
        ...
        //        Clone.transform.SetParent(platedParent.transform);
        //    }
        //    tutorial_countManage.ingredientCount[27]--;
        //    Debug.Log("치즈" + tutorial_countManage.ingredientCount[27]);

        //    if (tutorial_countManage.ingredientCount[27] == 0)
        //    {
        ...
        //        Clone.transform.SetParent(platedParent.transform);
        //    }
        //    tutorial_countManage.ingredientCount[28]--;
        //    Debug.Log("모짜렐라치즈" + tutorial_countManage.ingredientCount[28]);

        //    if (tutorial_countManage.ingredientCount[28] == 0)
        //    {
        ...
        //{
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[29]--;
        //    Debug.Log("생크림남은횟수" + tutorial_countManage.ingredientCount[29]);
        //    if (tutorial_countManage.ingredientCount[29] == 0)
        //    {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[30]--;
        //    Debug.Log("아이스크림" + tutorial_countManage.ingredientCount[30]);

        //    if (tutorial_countManage.ingredientCount[30] == 0)
        //    {
        ...
        //{
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[31]--;
        //    Debug.Log("카라멜시럽남은횟수" + tutorial_countManage.ingredientCount[31]);
        //    if (tutorial_countManage.ingredientCount[31] == 0)
        //    {
        ...
        //{
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[32]--;
        //    Debug.Log("초코시럽남은횟수" + tutorial_countManage.ingredientCount[32]);
        //    if (tutorial_countManage.ingredientCount[32] == 0)
        //    {
        ...
        //{
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[33]--;
        //    Debug.Log("케찹남은횟수" + tutorial_countManage.ingredientCount[33]);
        //    if (tutorial_countManage.ingredientCount[33] == 0)
        //    {
        ...
        //{
        //    DecoCreate(touchedName);
        //    tutorial_countManage.ingredientCount[34]--;
        //    Debug.Log("마요네즈남은횟수" + tutorial_countManage.ingredientCount[34]);
        //    if (tutorial_countManage.ingredientCount[34] == 0)
        //    {
        ...
        //    if (platedNoodle_Clone)
        //    {
        //        Destroy(platedNoodle_Clone);
        //        Clone = Instantiate(platedNoodle_gochujang, platePosition, Quaternion.identity);
        //        Clone.transform.SetParent(platedParent.transform);
        //        tutorial_countManage.ingredientCount[35]--;
        //        if (tutorial_countManage.ingredientCount[35] == 0)
        //        {
        ...
        //    Clone.transform.SetParent(platedParent.transform);
        //    tutorial_countManage.ingredientCount[36]--;
        //    Debug.Log("마요네즈남은횟수" + tutorial_countManage.ingredientCount[36]);
        //    if (tutorial_countManage.ingredientCount[36] == 0)
        //    {
    ...
    void DrawNext()
    {
        script_tutoManager.tutoGraphic[37].SetActive(false);
        script_tutoManager.tutoGraphic[38].SetActive(true);
        tutoManager.GetComponent<BoxCollider2D>().enabled = true;
        tuto_Manager.tuto_i=38;
    }
}
