...
public class stage4_timerManage : MonoBehaviour
{
    ...
    private stage4_submitClick scriptSubmit;
    public GameObject submit;

    //방해물
    public GameObject speechManage;
    ...
    void  Start()
    {
        ...
        scriptSubmit = submit.GetComponent<stage4_submitClick>();
    ...
    private void OnMouseDown()
    {
        if (gameObject.name == "tutoStartBut")
        {
            ...
            stage4_submitClick.submitOn = true;
    ...
    void FixedUpdate()
    {
        if (startslider)
        {
            ...
            if (time <= 0) {
                ...
                startslider = false;
                stage4_submitClick.sliderStopped = true;
                ...
                scriptSubmit.finalScoreText.text = "최종점수 : " + stage4_submitClick.score.ToString() + "원";
    ...
    public void startTimer()
    {
        ...
        stage4_submitClick.submitOn = false;
