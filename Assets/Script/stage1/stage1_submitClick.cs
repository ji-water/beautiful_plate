...
public class stage1_submitClick : MonoBehaviour
{
   ...
   // public GameObject Slider;
    ...
    private void OnMouseDown()
    {
        ...
        //hint count
        stage1_checkHint.hintCount.SetActive(true);
        stage1_checkHint.hintCount.GetComponent<SpriteRenderer>().sprite = Resources.Load("Hint/hint3", typeof(Sprite)) as Sprite;
