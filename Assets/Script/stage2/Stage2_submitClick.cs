...
public class Stage2_submitClick : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        //hint count
        stage2_checkHint.hintCount.SetActive(true);
        stage2_checkHint.hintCount.GetComponent<SpriteRenderer>().sprite = Resources.Load("Hint/hint3", typeof(Sprite)) as Sprite;
