...
public class stage5_submitClick : MonoBehaviour
{
   ...
   // public GameObject Slider;
    ...
    private void OnMouseDown()
    {
        ...
        //hint count
        stage5_checkHint.hintCount.SetActive(true);
        stage5_checkHint.hintCount.GetComponent<SpriteRenderer>().sprite = Resources.Load("Hint/hint3", typeof(Sprite)) as Sprite;
