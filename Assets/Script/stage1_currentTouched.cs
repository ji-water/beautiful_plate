...
public class stage1_currentTouched : MonoBehaviour
{
    //탭의 재료에 붙어있음
   ...
   public GameObject gamemanager;
    ...
    private void OnMouseDown()
    {
        ...
        scriptIngredient.touchedTissue.SetActive(false); //티슈 선택된거 비활성화
        stage1_clicktissue.tissueClicked = false;

        stage1_clicktissue.platedColliderInactive();//접시 위 재료 콜라이더 비활성화
