...
public class stage3_submitClick : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        //hint count
        stage3_checkHint.hintCount.SetActive(true);
        stage3_checkHint.hintCount.GetComponent<SpriteRenderer>().sprite = Resources.Load("Hint/hint3", typeof(Sprite)) as Sprite;
